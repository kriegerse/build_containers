...
BUILD_PRIMARY_TAG="${CI_COMMIT_SHORT_SHA}"
# BUILD_SECONDARY_TAGS="branch-${CI_COMMIT_BRANCH} commit-${CI_COMMIT_SHORT_SHA}"
BUILD_SECONDARY_TAGS="commit-${CI_COMMIT_SHORT_SHA}"
